...
def summarize_frame(run_dir, cluster_meta, final_meta, profile_row, clusters, args, frame_id_override=None):
    ...
    row.update({
        ...
        "color_contour_refresh_roi_stereo_dropped_count": as_int(
            profile_row.get("color_contour_refresh_roi_stereo_dropped_count")
        ),
        "color_contour_refresh_roi_stereo_dropped_pixels": as_int(
            profile_row.get("color_contour_refresh_roi_stereo_dropped_pixels")
        ),

...
def main():
    ...
    with leaderboard.open("w", encoding="utf-8", newline="") as f:
        ...
        writer.writerow([
            ...
            "driving_risk_roi_enabled_count", "driving_risk_roi_pixels_p50",
            "driving_risk_roi_percent_p50", "driving_risk_roi_clipped_all_dirty_count",
            "semantic_processing_frame_count", "semantic_processed_percent_p50",
            "semantic_processed_percent_p95", "semantic_processed_percent_mean",
            "semantic_full_frame_equivalent", "semantic_workload_reduction_percent",
        ...
        for s in scores:
            writer.writerow([
                ...
                metric(s, "driving_risk_roi_enabled_count"),
                metric(s, "driving_risk_roi_pixels_p50"),
                metric(s, "driving_risk_roi_percent_p50"),
                metric(s, "driving_risk_roi_clipped_all_dirty_count"),
                metric(s, "semantic_processing_frame_count"),
                metric(s, "semantic_processed_percent_p50"),
                metric(s, "semantic_processed_percent_p95"),
                metric(s, "semantic_processed_percent_mean"),
                metric(s, "semantic_full_frame_equivalent"),
                metric(s, "semantic_workload_reduction_percent"),

...
| replay_motion_slow_pan_001 | codex/imu-gravity-check | 71318a5+local | slow_pan_far_object real replay | test motion refresh, async refresh, and cooldown candidates against real slow camera pan | full-profile scoring: 15/16 pass; candidate_0028 is slow-pan stage winner with p95 69.0991ms, max 98.105ms, over_100ms_count 0 | candidate_0028 promoted only to best_replay_motion_slow_pan bucket; it is coarse and still needs hand_occlusion_reappear plus visual review |

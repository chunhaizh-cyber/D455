...
| replay_motion_slow_pan_001 | codex/imu-gravity-check | e997d81+local | slow_pan_far_object real replay | test motion refresh and async refresh candidates against real slow camera pan | full-profile scoring: 13/14 pass; candidate_0024 leads profile p95 at 69.3079ms; candidate_0027 lowers max frame to 101.534ms but scores slightly lower | sampled export p95 exposed refresh spikes; low-priority worker did not help; no motion-best promotion yet |

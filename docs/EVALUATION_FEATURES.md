...
```csv
frame_id,total_frame_ms,total_pixels,clustered_pixels,unknown_pixels,cluster_coverage_percent,unknown_percent,precise_depth3d_pixels,approx_stereo_contour_pixels,image_only_contour_pixels,background_pixels,depth_hole_candidate_pixels,near_cluster_count,far_cluster_count,image_only_cluster_count,background_cluster_count,unknown_cluster_count,total_cluster_count,reliable_depth_pixels,depth_hole_pixels,stable_track_count,new_track_count,lost_track_count,stereo_matched_cluster_count,stereo_failed_cluster_count,unknown_spike,merge_event,split_event,far_stereo_failed_event,contour_lost_event
```
